...
class AVL_vend{
    ...
    intreeClientaux(id, idclient,tmphead){        
        ...
        // console.log(tmphead)
        if (tmphead.data.id == id){
            if(tmphead.cliente.isinProv(idclient)){
                return true
            }else{
                return false
            }
    ...
    intreemonth(tempVendedor, id_mes){  
        return tempVendedor.mes.isinMonth(id_mes)     
        // if(this.head!=null){
    ...
    intreemonthaux(id, id_mes,tmphead){        
        ...
        // console.log(tmphead)
        if (tmphead.data.id == id){
            if(tmphead.mes.isinProv(id_mes)){
                return true
            }else{
                return false
            }
...
var c1 =new Vendedoresobj(1, "cliente1", "mail")
var c2 =new Vendedoresobj(2, "cliente2", "asfd")
...
if(lista_tem!=null){
    ...
    //auxiliar son cada uno de mis vendedores
    // let Vendedoraux = lista.head;
    // let Vendedoraux2 = lista.head;
    // while(Vendedoraux!= null){
    //     //Recuperacion de los CLIENTES
    ...
    //         Vendedoraux.mes.calendar=calendarnew
    //         calendaraux=calendaraux.siguiente
    //     }
    ...
    // sessionStorage.setItem("vendedor",JSON.stringify(lista_temp))
    sessionStorage.setItem("vendedor",lista_temp)
}else{
    var va = new AVL_vend();
    va.insertar(v1)
    va.insertar(v2)
    va.insertar(v3)
    va.insetar_Cliente(1,v1)
    va.insetar_Cliente(1,v2)
    va.insetar_Mes(1,1)
    va.insetar_Mes(1,2)
    va.insetar_Mes(1,12)
